import { getMovieCredits, getMovieDetails, getMovieImages, getMovieLatest, getMovieNowPlaying, getMovieRecommendations, getMovieReviews, getMovieSimilar, getMovieVideos } from '../controllers';
